...
function enableTileOverflow() {
  console.log('allowTileOverflow()');
  document.getElementsByClassName('tiles-image')[0].style.overflow = 'visible';
}

function disableTileOverflow() {
  console.log('disableTileOverflow()');
  document.getElementsByClassName('tiles-image')[0].style.overflowY = 'visible';
  document.getElementsByClassName('tiles-image')[0].style.overflowX = 'scroll';
}

var Tile = function Tile(_ref) {
  var tile = _ref.tile;
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
    onMouseEnter: enableTileOverflow,
    onMouseOut: disableTileOverflow,
...
//# sourceMappingURL=index.js.7cfad0b548fe0883bf0d.hot-update.js.map