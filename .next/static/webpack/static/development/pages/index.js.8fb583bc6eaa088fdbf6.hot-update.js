...
function enableTileOverflow() {
  ...
  document.getElementsByClassName('tile')[0].style.overflow = 'visible';
}

function disableTileOverflow() {
  console.log('disableTileOverflow()');
  document.getElementsByClassName('tile')[0].style.overflowY = 'visible';
  document.getElementsByClassName('tile')[0].style.overflowX = 'scroll';
}
...
//# sourceMappingURL=index.js.8fb583bc6eaa088fdbf6.hot-update.js.map