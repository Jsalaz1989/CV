...
function enableTileOverflow() {
  ...
  document.getElementsByClassName('tile-image')[0].style.overflow = 'visible';
}

function disableTileOverflow() {
  console.log('disableTileOverflow()');
  document.getElementsByClassName('tile-image')[0].style.overflowY = 'visible';
  document.getElementsByClassName('tile-image')[0].style.overflowX = 'scroll';
}
...
//# sourceMappingURL=index.js.eea7b521e61b547530aa.hot-update.js.map